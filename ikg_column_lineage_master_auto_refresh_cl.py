...
class ColumnLineageParser:
    ...
    def _process_create_statement(self, create_node: exp.Create, placeholders: Dict[str, str]) -> List[Dict]:
        ...
        full_sql = create_node.sql(dialect="postgres")
        records.append({
    ...
    def _process_joins(
        ...
        for join in joins:
            ...
            if on_condition:
                ...
                logic = on_condition.sql(dialect="postgres")
    ...
    def _process_where(
        ...
        if where_expr:
            logic = where_expr.sql(dialect="postgres")
    ...
    def _process_having(
        ...
        if having_expr:
            logic = having_expr.sql(dialect="postgres")
